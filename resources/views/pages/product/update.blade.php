    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left" data-ng-click="deleteProduct(product.id)">Delete</button>
                <button type="button" class="btn btn-primary" data-ng-click="updateProductById(product.id)">Update</button>
            </div>
        </div>
    </div>
</div>